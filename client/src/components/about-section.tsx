        ...
        <div className="bg-black/50">
          <div className="max-w-5xl mx-auto mb-24">
            <div className="text-center mb-16 ">
              <span className="inline-block px-10 py-2 text-sm font-semibold text-blue-700 bg-white/90 rounded-full mb-4 shadow-md border border-blue-100">
                Who We Are
              </span>
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-4xl mx-auto">
                NextGen Technology Limited (PNG) is a locally owned company. It
                is one of the few ICT companies in Papua New Guinea.
              </p>
            </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-2xl border border-white/30">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-4xl mx-auto mb-12">
                We are proud to be recognized and certified by leading industry
                organizations.
              </p>
            </div>
            ...
            <div className="mt-12 text-center">
              <p className="text-gray-600 mb-6">
                All our accreditations are available upon request. Contact us
