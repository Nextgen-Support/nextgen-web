    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-atech-slate-600 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6 max-w-4xl mx-auto">
          <Card className="bg-gray-300">
            <CardContent className="p-3 text-center">
              ...
              <h3 className="text-sm font-semibold text-atech-slate-900 mb-4">WhatsApp</h3>
          ...
          <Card className="bg-gray-300">
            <CardContent className="p-3 text-center">
              ...
              <h3 className="text-sm font-semibold text-atech-slate-900 mb-4">Email</h3>
          ...
          <Card className="bg-gray-300 md:col-span-2 lg:col-span-1">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-sm font-semibold text-atech-slate-900 mb-3">Global Services</h3>
