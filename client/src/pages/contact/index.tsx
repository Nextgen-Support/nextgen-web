  ...
  return (
    <div className="min-h-screen pt-24 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center my-12 text-white">Contact Us</h1>
        ...
        <div className="bg-black/50 rounded-lg shadow-lg p-8">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">Mutual Rumana Building - Waigani Sect. 405. Lot 12 & 13, Port Moresby, National Capital District</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">+675 325 2025</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">enquiry@nextgenpng.net</p>
            </div>
          </div>
        </div>
      </div>
